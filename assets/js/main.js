...
const WeatherAPIModule = (function () {
  const WEATHER_API_KEY = '0fd1d6a1ad8442d092d115918250805';
  const GEOCODE_API_KEY = '6d0e711d72d74daeb2b0bfd2a5cdfdba';
...
const DOMManipulationModule = (function () {
  ...
  function displayTodayWeather(data) {
    ...
    const { temp_c, last_updated_epoch: epochTime, wind_kph: wind } = current;
    ...
    todayWeather.querySelector('.degree').innerHTML = `${temp_c}<sup>o</sup>C`;
